...
/*package*/ class Condition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.sensor$P1WY;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.sensor$P1WY);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.status$c$CK;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
